...
*Control of Corruption* \@ref(fig:control-of-corruption) **[[View in Full Screen](/widgets/WGI_corruption_2021.html)]**
...
knitr::include_url("https://www.renanperes.com/widgets/WGI_corruption_2021.html", height = "400px")
```

*Government Effectiveness* \@ref(fig:government-effectiveness) **[[View in Full Screen](/widgets/WGI_corruption_2021.html)]**

```{r government-effectiveness, fig.cap='2021 Government Effectiveness.', tidy=FALSE}
...
# Highcharter
map_effectiveness_2021 <- hcmap(map = "custom/world-robinson-lowres", 
                                 download_map_data = FALSE,
                                 data = df_effectiveness,
                                 name = "Government Effectiveness:", color = "#75aadb",
                                 value = "GNI",
                                 borderWidth = 0,
                                 nullColor = "#d3d3d3",
                                 joinBy = c("iso-a3", "country_code")) %>% 
  
                          hc_colorAxis(stops = color_stops(n = 5, colors = c("#211d1f", "#21908C", "#FDE725"))) %>% 
    
                          hc_title(text = "<b>Government Effectiveness</b>",
                                   margin = 5,
                                   floating= FALSE,
                                   align = "center",
                                   style = list(fontSize = "28px",
...
print(map_effectiveness_2021)
# htmlwidgets::saveWidget(map_effectiveness_2021, "WGI_effectiveness_2021.html")
knitr::include_url("https://www.renanperes.com/widgets/WGI_effectiveness_2021.html", height = "400px")
```
