...
#### [View Full Screen]("https://www.renanperes.com/widgets/WGI_DT.html")
...
# Transforming Master Table
df <- df %>% 
        mutate_at(.vars = c("country_name", "indicator_name", "region", "continent"), .funs = str_to_title) %>% 
...
knitr::include_url("https://www.renanperes.com/widgets/WGI_DT.html")
```
