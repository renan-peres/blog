...
As this is a significant project which involves variables across many different countries, I thought the best way to explore the results would be to first make a map with the most recent indicator results comparing all nations and, second, compare the results grouped by continent over a period of the last five years, and lastly comparing the results between the countries in North America - Canada, Mexico, and the United States. Therefore, the three different interactive charts below accomplish the requisites mentioned above. Feel free to explore them as you wish!
