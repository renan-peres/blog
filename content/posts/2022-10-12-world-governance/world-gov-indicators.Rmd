...
### Most Recent Results ***(2021)***  \@ref(fig:wgi-2021) 
...
df_2021 <- df %>% 
            ...
            mutate(mean = mean(c_across(3:8)),
                   mean = round(mean, 2)) %>% 
            rename(political_stability = "political_stability_and_absence_of_violence_terrorism")
...
### USA Results \@ref(fig:USA-Indicators) 
#### **[[View Map in Full Screen](/widgets/USA_Governance_Results.html)]**

```{r USA-Indicators, fig.cap='USA Governance Results.', tidy=FALSE}
plot_USA <- df %>% 
              ...
              select(Country = country_name, 
                     ...
                     Year = year, 
                     Score = value) %>% 
              mutate(Indicator = case_when(Indicator == "Political Stability and Absence of Violence/Terrorism" ~ "Political Stability",
                                                T ~ Indicator),
                     Score = round(Score, 2)) %>% 
              ...
              labs(title = "USA Govenance Indicators", 
                   x = element_blank(), 
                   y = element_blank(),
                   color = "") +
...
plot_USA <- plot_USA %>% 
              ...
              config(displaylogo = FALSE,
                     ...
                     toImageButtonOptions = list(format = "svg",
                                                 filename = "USA_Governance_Results"))

# htmlwidgets::saveWidget(plot_USA, file = "USA_Governance_Results.html")
knitr::include_url("https://www.renanperes.com/widgets/USA_Governance_Results.html", height = "400px")
