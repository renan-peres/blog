...
### Global Results ***(Most Recent: 2021)***  \@ref(fig:wgi-2021) 
...
### North America Comparison \@ref(fig:north-america) 
...
north_america_plotly <- ggplotly(north_america, tooltip = c("Year", "Score")) %>% 
